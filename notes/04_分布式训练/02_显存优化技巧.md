...
![ZeRO 原论文图：参数、梯度、优化器状态的分片显存对比](https://ar5iv.labs.arxiv.org/html/1910.02054/assets/x1.png)
...
| 📖 PyTorch Docs | [FullyShardedDataParallel](https://docs.pytorch.org/docs/stable/fsdp.html) | FSDP 官方文档，理解参数/梯度/优化器分片 |
