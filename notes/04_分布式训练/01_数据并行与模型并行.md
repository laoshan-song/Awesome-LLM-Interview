...
| 平台 | 标题 | 说明 |
|------|------|------|
| 📺 B站 | [动画理解PyTorch大模型分布式训练：DP、DDP、DeepSpeed ZeRO](https://www.bilibili.com/video/BV1mz421Y7XN/) | 5.5万播放，动画直观展示三种并行策略原理 |
| 📺 B站 | [细节怪-手撕LLM：DeepSpeed详解（ZeRO三阶段和底层通信原理）](https://www.bilibili.com/video/BV1Xm421i7kK/) | 5189播放，ZeRO三阶段底层通信原理深入解析 |
| 📺 B站 | [DeepSpeed优化器并行ZeRO1/2/3原理](https://www.bilibili.com/video/BV1Df421X72G/) | 1.6万播放，ZOMI酱系统讲解ZeRO三阶段 |
