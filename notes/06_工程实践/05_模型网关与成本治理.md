...
- [RouterEval: A Comprehensive Benchmark for Routing LLMs](https://arxiv.org/abs/2503.10657)：专门评估 LLM routing 的 benchmark，适合补充“路由怎么评估”。
- [RouteNLP: Closed-Loop LLM Routing with Conformal Cascading and Distillation Co-Optimization](https://arxiv.org/abs/2604.23577)：更偏生产闭环的 routing/cascade/distillation 框架，可作为企业降本案例阅读。
...
- [LiteLLM Routing, Load Balancing & Fallbacks](https://docs.litellm.ai/docs/routing)：模型路由、fallback、负载均衡的工程配置。
- [Portkey AI Gateway](https://portkey.ai/docs/welcome/integration-guides/ai-gateway)：商业化 AI Gateway 的设计参考，包含治理、观测和路由概念。
