...
![AWQ 原论文图：保护少量重要权重可显著降低量化损失](https://ar5iv.labs.arxiv.org/html/2306.00978/assets/x1.png)

> 图源：[AWQ: Activation-aware Weight Quantization](https://arxiv.org/abs/2306.00978)。这张图适合解释 AWQ 的核心直觉：并非所有权重同等重要，保护少量 salient weights 能保持模型质量。
...
| 平台 | 标题 | 说明 |
|------|------|------|
| 📺 B站 | [【13】GPTQ、AWQ、GGUF等模型量化概念讲解](https://www.bilibili.com/video/BV1euPkerEun/) | 2.4万播放，系统讲解主流量化方案 |
| 📺 B站 | [DeepSpeed优化器并行ZeRO1/2/3原理（含量化内容）](https://www.bilibili.com/video/BV1fb421t7KN/) | 1.6万播放，ZOMI酱深入讲解量化与并行 |
| 📖 Hugging Face Docs | [bitsandbytes quantization](https://huggingface.co/docs/transformers/main/quantization/bitsandbytes) | 8-bit / 4-bit 加载和 QLoRA 常用工具 |
| 📖 Hugging Face Docs | [Quanto quantization](https://huggingface.co/docs/transformers/main/en/quantization/quanto) | Transformers 官方量化入口之一 |
| 📖 llama.cpp | [GGUF / llama.cpp](https://github.com/ggml-org/llama.cpp) | 本地部署和 GGUF/K-Quant 生态入口 |
| 📖 AutoAWQ | [AutoAWQ GitHub](https://github.com/casper-hansen/AutoAWQ) | AWQ 工程实现参考 |
