...
| 平台 | 标题 | 说明 |
|------|------|------|
| 📺 B站 | [Andrej Karpathy【中英】从零构建GPT（重制版）](https://www.bilibili.com/video/BV1Kc411e7XH/) | 4.6万播放，含Greedy/Sampling/Temperature等策略的完整实现 |
| 📺 B站 | [Token、多模态、LLM、Agent到底是什么意思？](https://www.bilibili.com/video/BV1bC4y1s7Ry/) | 6.9万播放，含解码策略基础概念讲解 |
