...
| 📖 LangGraph Docs | [LangGraph concepts](https://langchain-ai.github.io/langgraph/concepts/) | 官方 Agent 图编排文档 |
| 📖 MCP Docs | [Model Context Protocol](https://modelcontextprotocol.io/docs) | MCP 官方文档，理解 tools/resources/prompts |
