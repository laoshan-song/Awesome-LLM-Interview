...
| 平台 | 标题 | 说明 |
|------|------|------|
| 📄 Paper | [DeepSeekMath: Pushing the Limits of Mathematical Reasoning in Open Language Models](https://arxiv.org/abs/2402.03300) | GRPO 相关训练方法来源之一，适合追公式与动机 |
| 📄 Paper | [DAPO: An Open-Source LLM Reinforcement Learning System at Scale](https://arxiv.org/abs/2503.14476) | DAPO 方法与工程细节原始论文 |
| 📺 B站 | [图解DeepSeek的GRPO原理 + debug形式阅读GRPO源码](https://www.bilibili.com/video/BV1wFNCehERn/) | 3万播放，源码级讲解GRPO实现细节 |
| 📖 GitHub | [verl](https://github.com/volcengine/verl) | 大规模 RLHF/GRPO/DAPO 训练框架项目页 |
